...
import { useLgaUsers, useUsers } from "../../hooks/user";
...
function UserEdit({user}){
    ...
    const navigateToUser = ()=>navigate("/lga/unregistered/user",{state:user})
    return(
        <>
...
export default function LgaUnRegisteredUsers(){
    const {users,loading} = useLgaUsers();
