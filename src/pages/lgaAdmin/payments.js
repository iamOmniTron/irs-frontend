...
import { useLGAPayments, usePayments } from "../../hooks/payment";
...
export default function LgaPayments(){

    const user = userStore(state=>state.user)

    const {loading,payments} = useLGAPayments(user.LocalGovernmentAreaId)
    return(
        <>
