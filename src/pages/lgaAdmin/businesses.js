...
import { useBusinesses, useLgaBusinesses } from "../../hooks/business";
...
function BusinessEdit({business}){
    ...
    const navigateToBusiness = ()=>navigate("/lga/business",{state:business})
    return(
        <>
...
export default function LgaBusiness(){

    const {loading,businesses} = useLgaBusinesses();
    return(
        <>
